# openaq_bronze_pipeline

This folder defines all source code for the 'openaq_bronze_pipeline' pipeline:
...
* Take a look at the sample under "sample_users_openaq_bronze_pipeline.py" to get familiar with the syntax.
